...
/**
 * @author Imxu
 * @time 2019/7/27 11:55
 * @des ${TODO}
 */
public class LSLog {

    private static String LOG_TAG = "HUANGBAOCHE";
    private static boolean ISDEBUG = true; //默认打开日志
    private static boolean IS_SHOW_THREAD = false; //默认不显示线程信息
    private static int METHOD_COUNT = 3; //方法显示层级
    ...
    public static void setMethodCount(int methodCount) {
        LSLog.METHOD_COUNT = methodCount;
        init();
    }
