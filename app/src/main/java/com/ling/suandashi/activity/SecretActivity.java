...
public class SecretActivity extends BasicActivity{
    ...
    private String secret = "\n灵算大师（以下或称“我们”）注重保护用户个人信息及个人隐私。本隐私政策包含我们收集、处理、存储、使用、共享、转让、公开披露\t和保护用户（“您”）个人信息（以下或称“信息”）的有关条款。\n" +
            "本政策将帮助您了解以下内容：\n" +
            "1、我们如何收集和使用您的个人信息；\n" +
            ...
            "一、适用范围\n" +
            "本隐私政策适用于灵算大师平台提供的所有服务（以下称“服务”或“我们的服务”），您访问灵算大师平台及/或登陆相关客户端使用灵算大师提供的服务，均适用本隐私政策。\n" +
            "本政策所称“灵算大师平台”包括但不限于灵算大师等网站及客户端、以及相关微信公众号平台。\n" +
            "本政策所称“灵算大师”是灵算大师平台经营者上海汉涛信息咨询有限公司及现有和/或未来设立的相关关联公司的单称或合称。\n" +
            "本政策最近更新日期：2018年3月20日。\n" +
            ...
            "二、我们如何收集您的个人信息\n" +
            "个人信息是指以电子或者其他方式记录的能够单独或者与其他信息结合识别特定自然人身份或者反映特定自然人活动情况的各种信息。个人敏感信息是指一旦泄露、非法提供或滥用可能危害人身和财产安全，极易导致个人名誉、身心健康受到损害或歧视性待遇等的个人信息，本隐私政策中涉及的个人敏感信息包括：您的财产信息（包括交易记录及账户余额、优惠券、积分、等级等虚拟财产信息）；面部识别特征；个人身份信息（包括身份证、军官证、护照、驾驶证、户口本）；网络身份识别信息（包括账户名、账户昵称、邮箱地址及与前述有关的密码与密码保护问题和答案）；其他信息（包括通讯录、个人电话号码、手机号码、行程信息、网页浏览记录、住宿信息、精准定位信息）。\n" +
            ...
            "您在灵算大师平台发布点评内容过程中所提交的任何文字、照片、视频等各种形式的信息，也可能会包含或者关联到您的个人信息。\n" +
            "您可以选择不提供某一或某些信息，但是这样可能使您无法使用我们的许多特色服务。请您理解，我们使用您提供的信息是为了回应您的要求，为您享受我们提供的团购、预订等各项服务提供便利，完善我们的网站以及与您进行信息沟通。\n" +
            "2、我们在您使用服务过程中获得的信息\n" +
            ...
            "（2）您的位置信息。当您开启设备定位功能，下载或使用我们、关联方及合作伙伴开发的应用程序（例如灵算大师APP、灵算大师APP），或访问移动网页使用我们服务时，我们可能会读取您的位置（大多数移动设备将允许您关闭定位服务，具体方法建议您联系您的移动设备的服务商或生产商）。\n" +
            ...
            "6、让您参与有关我们产品及服务的调查。\n" +
            "7、经您同意或授权的其他用途。\n" +
            "（1）基于用户帐户安全、发放团购券、进行商品配送以及提供其他服务等需要，我们需在用户注册、使用灵算大师服务（包括使用手机客户端）时收集并使用用户的手机号码、电子邮件、邮寄地址、所在位置等必要的个人信息。\n" +
            "（2）注册用户同意并授权我们保留用户的注册信息及用户使用我们服务期间的全部交易信息、点评信息等。\n" +
            "（3）为了用户更加便捷、安全的使用我们的服务，我们将使用Cookies收集用户与我们服务有关的特征信息，用于标识用户的设备。\n" +
            "（4）为了使用户及时知晓最新团购资讯、优惠动态以及我们的网站管理、运营等相关信息，用户同意接收我们通过各种形式，包括但不限于电子邮件、手机短信等方式向用户发送团购促销、通知信息、广告信息或其他相关商业信息。但用户可以随时通知我们或通过提示的设置方式取消该等发送。\n" +
            "四、您共享的信息\n" +
            "您可以通过我们的服务建立联系和相互分享。当您通过我们的服务创建交流、交易或分享时，您可以允许灵算大师访问您的电脑、手机或其他第三方社交平台的通讯录，从而使您通讯录中同样通过我们的服务开通分享功能的联系人，能够看到您在灵算大师上的交易信息、评价以及其他的分享内容。您还可以通过我们的服务邀请尚未开通分享功能的联系人开通该功能，从而使其可以看到您在灵算大师上的交易信息、评价以及其他的分享内容。\n" +
            "在使用灵算大师平台服务进行交易时，您不可避免的要向交易对方或潜在的交易对方披露自己的个人信息，如联络方式或者邮政地址。请您妥善保护自己的个人信息，仅在必要的情形下向他人提供。如您发现自己的个人信息泄密，尤其是您的账户或密码发生泄露，请您立即联络灵算大师，以便灵算大师采取相应措施。\n" +
            "公开信息是指您自愿公开分享的任何信息。任何人都可以在使用和未使用灵算大师期间查看或访问这些信息。\n" +
            "为使用灵算大师服务，可能存在您必须公开分享的信息。例如为构建诚信交易环境，您的信用评价信息需要被公开分享。若您是产品或服务提供方/出售方，您应当根据适用的法律法规和灵算大师规则的要求，公开分享经营信息。\n" +
            ...
            "3、出于实现“我们对您个人信息的使用”部分所述目的，或为履行我们在灵算大师《用户服务协议》或本隐私政策中的义务和行使我们的权利，向我们的关联方、合作伙伴或代表我们履行某项职能的第三方（例如代表我们发出推送通知的通讯服务商、处理银行卡的支付机构等）分享您的个人信息。\n" +
            ...
            "与授权合作伙伴共享。仅为实现本政策中声明的目的，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。例如，在您使用我们外卖配送服务时，我们必须与物流服务提供商共享您的个人信息才能安排送货，或者安排合作伙伴提供服务。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。\n" +
            ...
            "我们将定期更新并公开安全风险、个人信息安全影响评估等报告的有关内容。您可通过进入灵算大师站首页相关模块或联系我们的客服获取。\n" +
            ...
            "账户信息——如果您希望访问或编辑您的账户中的个人资料信息和支付信息、更改您的密码、添加安全信息或关闭您的账户等，您可以通过访问灵算大师网页执行此类操作。\n" +
            "如果您无法通过上述链接访问这些个人信息，您可以随时联系我们的客服。我们将尽快回复您的访问请求。\n" +
            "（二）更正您的个人信息；\n" +
            "（三）删除您的个人信息；\n" +
            "（四）改变您授权同意的范围。\n" +
            "以上信息您均可以通过灵算大师网站主页进行访问和更新。\n" +
            "如果您认为灵算大师存在违反法律的规定收集、使用您个人信息的情形，您可以通过灵算大师客服与我们取得联系。\n" +
            "九、如何使用Cookie及网络 Beacon\n" +
            "1、Cookie的使用\n" +
